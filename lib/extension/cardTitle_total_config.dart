 ...
 * @LastEditTime: 2023-09-24 20:46:40
...
class CardTitleTotalConfig extends BaseTotalConfig {
  ...
  CardTitleConfig get cardTitleConfig =>
      _actionSheetConfig ?? BaseCardTitleConfigUtils.defaultCardTitleConfig;
...
extension BaseCardTitleTotalConfig on BaseTotalConfig {
  static CardTitleConfig? _actionSheetConfig;
  CardTitleConfig get cardTitleConfig =>
      _actionSheetConfig ?? BaseCardTitleConfigUtils.defaultCardTitleConfig;
  set actionSheetTotalConfig(CardTitleTotalConfig config) {
    _actionSheetConfig = config.cardTitleConfig;
  }
}
