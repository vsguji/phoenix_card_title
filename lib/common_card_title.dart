...
class CommonCardTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    CardTitleConfig cardTitleConfig = CardTitleConfig(
        alignment: alignment,
        cardTitlePadding: padding as EdgeInsets?,
        detailTextStyle: BaseTextStyle(color: detailColor));
  ...
  ///标题widget
  Widget _titleWidget(BuildContext context, CardTitleConfig defaultConfig) {
  ...
  ///标题下方的widget
  Widget _detailTextWidget(CardTitleConfig defaultConfig) {
    Text tx = Text(
      detailTextString ?? "",
